...
import CalendarTotal from 'src/tasks/Calendar/CalendarTotal'
import ProjectList from 'src/tasks/Calendar/ProjectList'

import { useEffect, useMemo, useState } from 'react'
import { useNavigate } from 'react-router-dom'
import { useSelector, useDispatch } from 'react-redux'

// import { Select, Space } from 'antd' // Temporarily disabled for build compatibility

import moment from 'moment'
import 'moment/locale/ko'
import { refetchProject } from 'src/utils/util'
...
export default function Calendar() {
  ...
  // const { Option } = Select // Temporarily disabled for build compatibility
              ...
              <div className="type">
                <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                  ...
                  <select
                    ...
                    style={{ width: 140 }}
                    value={DateType}
                    onChange={(e) => DateTypeChange(e.target.value)}
                  >
                    {DateList.map((option) => (
