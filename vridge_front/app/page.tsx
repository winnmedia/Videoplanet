...
// Import images using Next.js approach
import logo from '/public/images/Common/w_logo.svg'
import icon01 from '/public/images/Home/icon01.svg'
import icon02 from '/public/images/Home/icon02.svg'
import icon03 from '/public/images/Home/icon03.svg'
import icon04 from '/public/images/Home/icon04.svg'
import chat from '/public/images/Home/chat_icon.png'
import emoji01 from '/public/images/Home/emoji01.png'
import emoji02 from '/public/images/Home/emoji02.png'
import emoji03 from '/public/images/Home/emoji03.png'
import emoji04 from '/public/images/Home/emoji04.png'
import img08 from '/public/images/Home/img08.png'
import img09 from '/public/images/Home/img09.png'
import img10 from '/public/images/Home/img10.png'

import tool from '/public/images/Home/new/tool.png'
import tool02 from '/public/images/Home/new/tool02.png'
import visual from '/public/images/Home/new/visual-img.png'
import feedback from '/public/images/Home/new/feedback-img.png'
import project from '/public/images/Home/new/project-img.png'
import comment from '/public/images/Home/new/comment-img.png'
import identity from '/public/images/Home/new/identity-img.png'
import identity02 from '/public/images/Home/new/identity-img02.png'
import identity03 from '/public/images/Home/new/identity-img03.png'
import identity04 from '/public/images/Home/new/identity-img04.png'
import end from '/public/images/Home/new/end-img.png'
import end02 from '/public/images/Home/new/end-img02.png'
      ...
      <section id="header">
        <div className="inner flex space_between align_center">
          ...
          <div className="etc">
            ...
            <button onClick={() => router.push('/login')} className="submit">
              로그인
            </button>
          </div>
        </div>
      ...
      <section id="container">
        <section className="visual">
          <div className="inner">
            ...
            <div className="img">
              <Image src={visual} alt="Visual representation" />
            </div>
          </div>
        </section>

        <section className="textbox">
          <Image src={tool02} alt="" />
          ...
          <div className="inner">
            ...
            <div className="group flex space_between">
              ...
              <div className="ex">
                <div className="part flex space_between align_center">
                  <div className="img">
                    <Image src={emoji01} className="img01" alt="Emoji 1" />
                  </div>
                  <div className="text">
                    <div>
                      <span>
            ...
            <div className="group flex space_between mt100">
              ...
              <div className="ex">
                <div className="part flex space_between align_center">
                  <div className="img">
                    <Image src={emoji02} className="img01" alt="Emoji 2" />
                  </div>
                  <div className="text">
                    <div>
                      <span>
                ...
                <div className="part flex space_between align_center mt50">
                  ...
                  <div className="img">
                    <Image src={emoji04} className="img02" alt="Emoji 4" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="end">
          ...
          <div className="ment">
            SAVE THE CREATORS <Image src={end02} alt="" />
          </div>
        </section>
      </section>
